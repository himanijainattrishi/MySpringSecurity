package com.niit.springsecurity.controller;
...
public class SpringSecurityController {
	...
	{
		model.addAttribute("title", "Spring Security with Database");
		model.addAttribute("message", "This is Welcome page of Spring Security");
		return "index";
	}
